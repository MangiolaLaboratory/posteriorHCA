...
The former combined vignette is split into two reports that share the same
marked steps:
...
- Core (matrix API): `vignette("cohort-expression-core", package = "posteriorHCA")`
- Wrappers (Seurat / formula): `vignette("cohort-expression-wrappers", package = "posteriorHCA")`
