...
dispersion estimated internally by `glmQLFit()` together with gene-specific
moderated quasi-dispersions. Earlier edgeR QL workflows commonly used
trended NB dispersions estimated with `estimateDisp()`; we currently treat
that as a sensitivity-analysis alternative.
### Simple group mean
