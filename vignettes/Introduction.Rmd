...
# composition_draws() needs cmdstanr (not always installed with sccomp)
has_sccomp_draws <- requireNamespace("sccomp", quietly = TRUE) &&
...
```{r eval = has_sccomp_draws, fig.width= 12, fig.height= 10 }
...
Both [composition_test()] / [composition_draws()] and [expression_draws()]
