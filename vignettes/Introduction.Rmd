...
#### Test and plot observed proportions
...
`composition_posterior_test()` remains as a convenience wrapper around
[load_sccomp_fit()], [composition_draws()], [composition_test()], and
[plot_composition_vs_hca()].
...
```{r eval = requireNamespace("sccomp", quietly = TRUE), fig.width= 12, fig.height= 10 }
print(plot_composition_vs_hca(comp_draws, test_results = test_results))
```
...
Both [composition_test()] / [composition_draws()] and [expr_predict()]
